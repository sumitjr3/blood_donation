...
class ListDonorScreen extends StatefulWidget {
  const ListDonorScreen({super.key});

  @override
  State<ListDonorScreen> createState() => _ListDonorScreenState();
}

class _ListDonorScreenState extends State<ListDonorScreen> {
  List<String> nameof = [
    'Wunmi Tunde',
    'Adekunle Kareem',
    'Mr. Tolu O.B.',
  ...
  List<String> bloodType = ['AB-', 'AB+', 'O+', 'A+', 'B+', 'O-', 'O-'];
